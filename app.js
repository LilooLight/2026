...
const I18N = {
  ru: {
    ...
    bpM1:'времени ключевых операций', bpM2num:'50 000+', bpM2:'пользователей', bpM3:'продуктов на единой дизайн-системе', bpM4:'рост дизайн-команды',
  ...
  cn: {
    ...
    bpSumLbl:'七年成果',
    bpM1:'关键操作时间', bpM2num:'5万+', bpM2:'用户数', bpM3:'统一设计系统覆盖的产品', bpM4:'设计团队规模增长',
